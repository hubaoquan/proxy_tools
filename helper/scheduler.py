...
def runScheduler():
    ...
    scheduler.add_job(_runProxyFetch, 'interval', minutes=60, id="proxy_fetch", name="proxy采集")
    scheduler.add_job(_runProxyCheck, 'interval', minutes=20, id="proxy_check", name="proxy检查")
